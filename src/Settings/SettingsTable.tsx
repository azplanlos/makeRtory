import { List, ListItem, ListItemIcon, ListItemText, ListSubheader, Switch, TextField } from "@mui/material";
import React, { useState } from "react";
import PermIdentityIcon from '@mui/icons-material/PermIdentity';
import PasswordIcon from '@mui/icons-material/Password';

export default function SettingsTable() {
    const [clientId, setClientId] = useState(localStorage.getItem("nexar-clientid") || "");
    const [clientSecret, setClientSecret] = useState(localStorage.getItem("nexar-clientsecret") || "");
  ...
  >
    ...
    <ListItem>
      ...
      <TextField type="password" variant="standard" sx={{width: '80%'}}
        value={clientSecret}
        onChange={(event) => {
